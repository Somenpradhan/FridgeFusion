        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="sm:col-span-2 space-y-4">
            ...
            <p className="text-slate-500 text-sm max-w-sm leading-relaxed">
              Reducing food waste through the power of Vision AI. Scan your fridge, save money, and cook delicious meals instantly.
            </p>
            <div className="flex gap-4 pt-2">
              <Instagram size={18} className="text-slate-400 hover:text-orange-600 cursor-pointer transition-colors" />
              <Twitter size={18} className="text-slate-400 hover:text-orange-600 cursor-pointer transition-colors" />
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-500">
              <li>
                <Link to="/" className="hover:text-orange-600 transition-colors">AI Fridge Scanner</Link>
              </li>
              <li>
                <Link to="/" className="hover:text-orange-600 transition-colors">Smart Substitutions</Link>
              </li>
              <li>
                <Link to="/" className="hover:text-orange-600 transition-colors">Expiry Alerts</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-500">
              <li>
                <Link to="/" className="hover:text-orange-600 transition-colors">Cooking Guides</Link>
              </li>
              <li>
                <Link to="/contact" className="text-orange-600 font-bold hover:underline flex items-center gap-2">
